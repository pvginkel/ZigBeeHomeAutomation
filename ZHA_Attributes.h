...
public:
	...
	uint8_t configureReporting(Zcl::DataType datatype, uint16_t minimumInterval, uint16_t maximumInterval, uint8_t reportableChange, uint16_t timeoutPeriod);
	void writeValue(Zcl::FrameAppender& frame);
